...
export default function Timeline() {
  const milestones = [
    {
      year: 2024,
      event: "Coordly founded",
      icon: "🚀",
      description: "Started with a vision to revolutionize collaboration.",
    },
    {
      year: 2024,
      event: "Launch of our first product",
      icon: "🎉",
      description: "A milestone that marked our entry into the market.",
    },
    {
      year: 2024,
      event: "Reached 100,000 users",
      icon: "🏆",
      description: "Growing community of passionate collaborators.",
    },
    {
      year: 2024,
      event: "Expanded to international markets",
      icon: "🌍",
      description: "Taking our solution to teams worldwide.",
    },
  ];
  ...
  return (
    <div ref={ref} className="mb-20 relative">
      ...
      >
        ...
        {/* Content card */}
        <div
          className={`w-5/12 ${index % 2 === 0 ? "mr-auto pr-12" : "ml-auto pl-12"}`}
        >
