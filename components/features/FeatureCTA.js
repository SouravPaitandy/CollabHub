  ...
  return (
    <section className="pt-20 bg-indigo-600 dark:bg-indigo-800">
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-white mb-4">Ready to Transform Your Team&apos;s Collaboration?</h2>
        <p className="text-xl text-indigo-100 mb-8">Join thousands of teams already using CollabHub to boost their productivity.</p>
        <Button href="/auth" className="bg-white text-indigo-600 hover:bg-indigo-50">
